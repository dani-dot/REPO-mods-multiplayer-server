...
This is an all in one guide to install REPO with preinstalled mods and i have named it REPO1
...
I have used awc21 's method for the custom server, if u want more information read his guide:
